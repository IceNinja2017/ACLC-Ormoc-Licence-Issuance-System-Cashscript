    ...
    <main className="auth-home">
      ...
      <section id="top" className="auth-page-layout">
        <div className="auth-page-copy">
          ...
          <p>
            Connect your Bitcoin Cash wallet to manage secure, non-transferable
            professional licenses — or to sign in as an administrator. No
            passwords, no email — your wallet is your identity.
          </p>
